...
const InstantInspection = () => {
  ...
  const filteredItems = useMemo(() => {
    return facilitiesData.filter((item) => {
      ...
      const matchesLetter =
        searchLetter === "None" ||
        item.name.toUpperCase().startsWith(searchLetter);
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 overflow-hidden max-w-7xl mx-auto">
        ...
        <div className="p-5 grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-4 items-end">
          <div className="md:col-span-8">
            <label className="block text-gray-500 text-[12px] mb-1">
              Facility
            </label>
          ...
          <div className="md:col-span-2">
            ...
            <select className="w-full border border-gray-300 rounded px-3 py-2 text-[14px]">
              <option>00</option>
            </select>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in duration-150">
            ...
            <div className="p-4 border-b flex justify-between items-center bg-white sticky top-0 z-10">
              <div className="flex gap-4">
                ...
                <button
                  onClick={() => navigate("/add-facility")} // apna route lagao
                  className="flex items-center gap-1.5 bg-[#3e49bb] text-white text-[11px] px-3 py-1.5 rounded hover:bg-blue-800 font-bold uppercase"
                >
                  <HiPlus size={14} />
                  Add New Facility
                </button>
            ...
            <div className="p-4 md:p-6 overflow-y-auto">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
                <div className="text-[14px] text-gray-600 font-medium">
                  Show{" "}
                  <select className="border border-gray-300 rounded px-1 py-1 mx-1 outline-none">
                    <option>10</option>
                  </select>{" "}
                  entries
                </div>
              ...
              <div className="rounded border border-gray-200">
                <DataTable
                  ...
                  highlightOnHover
                  noDataComponent={
                    <div className="p-4 text-gray-500">No facility found</div>
                  }
                />
              </div>
