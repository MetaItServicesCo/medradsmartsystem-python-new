  ...
  return (
    <>
      <div ref={btnRef} className="inline-flex shadow-sm rounded-md">
        <button
          onClick={handleOpen}
          className="bg-[#3e49bb] text-white px-1 py-1 rounded-l-md text-sm font-semibold hover:bg-blue-800 transition-all"
        >
          Actions
        </button>
        <button
        ...
        createPortal(
          ...
          >
            <button
              onClick={() => {
                setIsOpen(false);
                setTimeout(() => navigate(`/sales-parts/add/${row.id}`), 0);
              }}
...
const SalesList = () => {
  ...
  const data = [
    ...
    {
      id: 6,
      description: "Carm Table",
      partNumber: "MBMTSGE04",
      make: "STI",
      model: "Streamline 2",
      condition: "Refurbished",
      amount: 9500,
    ...
    {
      id: 7,
      description: "OEC 9800 with 90-day warranty half payment",
      partNumber: "MBMTSGE03",
      make: "GE",
      model: "OEC 9800",
      condition: "Refurbished",
      amount: 12500,
    ...
    {
      id: 8,
      description: "2008 GE Lunar Prodigy",
      partNumber: "MBMTSGE02",
      make: "GE",
      model: "Lunar Prodigy",
      condition: "Refurbished",
      amount: 17500,
    ...
    {
      id: 9,
      description: "2024 GE Lunar Prodigy Advance",
    ...
    {
      id: 11,
      description: "Hard drive and Software R5.2.2",
      partNumber: "HDDLQE",
      make: "",
      model: "",
      condition: "New",
    ...
    {
      id: 12,
      description: "Philips Monitor Cable",
      partNumber: "PHLMON01",
      make: "Philips",
      model: "M3001A",
      condition: "New",
    ...
    <div className="p-6 bg-gray-50 min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="flex justify-between items-center px-5 py-4 border-b border-gray-100">
          ...
          <button
            onClick={() => navigate("/sales-parts/add")}
