...
export default function RentalQoutationView() {
    ...
    <div style={s.page}>
      ...
      <div style={s.card}>
        ...
        <div style={{ marginTop: 28 }}>
          <div style={s.sectionTitle}>Parts Rent</div>
          <div style={s.tableWrap}>
            <table style={{ ...s.table, borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ ...s.thead, backgroundColor: "#f3f4f6" }}>
                  {[
                    "Number",
                    "Description",
                    "Per Day Rent",
              ...
              <tbody>
                {invoice.parts.map((p, i) => (
                  ...
                  >
                    <td style={{ ...s.td, border: "1px solid #e5e7eb" }}>
                      {p.number}
                    </td>
                    <td style={{ ...s.td, border: "1px solid #e5e7eb" }}>
                      {p.description}
