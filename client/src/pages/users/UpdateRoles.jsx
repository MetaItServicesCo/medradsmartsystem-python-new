...
// Permissions Data as per your requirements
...
const UpdateRoles = () => {
  ...
  // Initializing state for checkboxes and scope
    ...
    <div className="p-4 bg-gray-100 min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto bg-white rounded border border-gray-200 shadow-sm">
        ...
        <div className="px-5 py-3 flex justify-between items-center border-b border-gray-200">
          <h2 className="text-slate-600 font-medium text-sm">Update Role</h2>
          <button
            onClick={() => navigate(-1)}
        ...
        <div className="p-5">
          {/* --- Role Name Input with Dark Label Design --- */}
          ...
          <div className="mt-6">
            <button className="bg-[#3e49bb] text-white px-10 py-2.5 rounded font-bold text-sm shadow hover:bg-blue-800 transition-all active:scale-95">
              Submit
            </button>
          </div>
        </div>
