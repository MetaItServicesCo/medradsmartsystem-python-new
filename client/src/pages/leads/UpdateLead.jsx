...
const inputCls =
  "w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 bg-white";
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="Tell about what you discussed"
                rows={4}
                className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 bg-white resize-y"
              />
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        value={act.date}
                        onChange={(e) =>
                          updateActivity(act.id, "date", e.target.value)
                        }
                        className={inputCls}
                      />
                    </div>
