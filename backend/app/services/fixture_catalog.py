...
# Chairs, tables and displays are assets, not fixtures: they have their own
# tags and can be moved. They live in app/services/asset_catalog.py. The
# privacy curtain stays here because its track is part of the ceiling.
ROOM_FINISHES = [
    {
...
CATALOG: dict[str, list[dict]] = {
    ...
    "building_envelope": BUILDING + ROOM_FINISHES,
}
